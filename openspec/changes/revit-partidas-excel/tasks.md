...
| 16 | I1 | 1.21, 1.22 | `ExtractionService` + read-only guarantee | **~1770 actual** (est. 350-430, ≈4.5x; 613 of it the unplanned host harness in `tools/`; 9 commits, largest 314) | WIN | Revit 2027.2: 107.639 ft² → 10.0 m², document unmodified | Revert extraction; PR 15 shell still loads |
