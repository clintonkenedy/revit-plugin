...
public sealed class ReadOnlyTripwireTests
{
    ...
    [
        ...
        "Autodesk.Revit.DB.Document.GetWorksharingCentralModelPath",
        "Autodesk.Revit.DB.Document.get_IsDetached",
        "Autodesk.Revit.DB.Document.get_IsFamilyDocument",
        "Autodesk.Revit.DB.Document.get_IsModelInCloud",
        "Autodesk.Revit.DB.Document.get_IsWorkshared",
        ...
        "Autodesk.Revit.DB.ModelPath.get_Empty",
