...
public sealed class ReadOnlyTripwireTests
{
    ...
    [
        ...
        "Autodesk.Revit.DB.Architecture.Railing.GetMultistoryStairsPlacementLevels",
        "Autodesk.Revit.DB.Architecture.Railing.get_HostId",
        "Autodesk.Revit.DB.Architecture.Stairs.get_MultistoryStairsId",
        "Autodesk.Revit.DB.Architecture.Stairs.get_NumberOfStories",
        ...
        "Autodesk.Revit.DB.Category.get_Material",
        "Autodesk.Revit.DB.CompoundStructure.GetLayers",
        "Autodesk.Revit.DB.CompoundStructure.GetWallSweepsInfo",
        "Autodesk.Revit.DB.CompoundStructure.IsVerticallyHomogeneous",
        "Autodesk.Revit.DB.CompoundStructure.get_OpeningWrapping",
        "Autodesk.Revit.DB.CompoundStructure.get_VariableLayerIndex",
        "Autodesk.Revit.DB.CompoundStructureLayer.get_Function",
        "Autodesk.Revit.DB.CompoundStructureLayer.get_LayerCapFlag",
        "Autodesk.Revit.DB.CompoundStructureLayer.get_MaterialId",
        "Autodesk.Revit.DB.CompoundStructureLayer.get_Width",
        "Autodesk.Revit.DB.Curve.GetEndPoint",
        "Autodesk.Revit.DB.Curve.Tessellate",
        "Autodesk.Revit.DB.CurveLoop.Create",
        "Autodesk.Revit.DB.CurveLoop.IsCounterclockwise",
        ...
        "Autodesk.Revit.DB.Edge.AsCurveFollowingFace",
        "Autodesk.Revit.DB.Edge.GetFace",
        "Autodesk.Revit.DB.Edge.Tessellate",
        "Autodesk.Revit.DB.Element.GetMaterialArea",
        "Autodesk.Revit.DB.Element.GetMaterialIds",
        "Autodesk.Revit.DB.Element.GetMaterialVolume",
        "Autodesk.Revit.DB.ElementId.get_InvalidElementId",
        "Autodesk.Revit.DB.Face.GetEdgesAsCurveLoops",
        "Autodesk.Revit.DB.Element.GetGeneratingElementIds",
        "Autodesk.Revit.DB.Element.GetTypeId",
        ...
        "Autodesk.Revit.DB.Face.get_Area",
        "Autodesk.Revit.DB.Face.get_EdgeLoops",
        ...
        "Autodesk.Revit.DB.FamilyInstance.get_Symbol",
        ...
        "Autodesk.Revit.DB.Floor.GetSlabShapeEditor",
        "Autodesk.Revit.DB.GeometryObject.get_Id",
        ...
        "Autodesk.Revit.DB.PlanarFace.get_FaceNormal",
        "Autodesk.Revit.DB.RoofBase.GetSlabShapeEditor",
        "Autodesk.Revit.DB.Sketch.get_OwnerId",
        "Autodesk.Revit.DB.SlabShapeEditor.get_IsEnabled",
        "Autodesk.Revit.DB.Solid.get_Edges",
        "Autodesk.Revit.DB.Solid.get_Faces",
        "Autodesk.Revit.DB.Transform.OfPoint",
        "Autodesk.Revit.DB.UnitTypeId.get_CubicMeters",
        "Autodesk.Revit.DB.UnitTypeId.get_Meters",
