...
/// <summary>
/// One finished run: the criteria it measured under, the grouped budget, and the
/// report the user is shown.
/// </summary>
/// <remarks>
/// All three are kept because the assertions worth making are the ones that
/// compare them. A metrado is only interesting next to the raw quantity it came
/// from, and a run report is only interesting next to the budget it claims to
/// describe.
/// </remarks>
